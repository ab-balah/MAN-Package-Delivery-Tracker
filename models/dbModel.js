...
function addNewAccount(data) {
  ...
  let add_account_result = add_account_statement.run(data.Username, data.Password, data.Customer_SSN);
  ...
  let add_customer_statement = db.prepare("INSERT INTO Person(SSN, Fname, Lname, Phone, Email, Birth_Date) VALUES(?, ?, ?, ?, ?, ?);");
...
module.exports = { deletePackage, addPackage, updatePackageInfo, getPackagesInfo, getPackagesInfoByNumber, getSenderPackages, getIncomingPackages };
